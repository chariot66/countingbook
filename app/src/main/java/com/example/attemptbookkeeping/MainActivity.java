...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // click event
        // goto detail activity for a specific notebook
        ...
        // long click event
        // create custom dialog for modify & del notebook information
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int
                    position, long id) {
                // get the clicked notebook information
                com.example.attemptbookkeeping.MainPage.notebook currentNote = notebooks_list.get(position);
    ...
    /**
     * Read all record in the notebook DB
     * For the list view display and update
     */
    ...
    // the previous logic for modifing the note book information
